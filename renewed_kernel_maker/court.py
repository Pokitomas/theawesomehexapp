...
def cold_start_court() -> dict:
    ...
    return receipt("court.cold_start", {
        "returncode": p.returncode, "elapsed_ns": elapsed_ns, "elapsed_ms": elapsed_ns / 1e6,
        "stdout": p.stdout[-2000:], "passes": p.returncode == 0 and "archie-kernel-maker/v1" in p.stdout,
    })
