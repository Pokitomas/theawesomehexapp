...
export async function createHostedBackup({ provider, secretStore, dataRoot, serviceVersion, migrationLevel, clock = () => new Date() }) {
  ...
  const body = {
    ...
    claim_boundary: 'This backup contains exact digest-chained workspace events, admitted artifact bytes, and only encrypted secret envelopes. Raw founder, developer, and runner tokens and external session and encryption keys are intentionally absent.'
  };
