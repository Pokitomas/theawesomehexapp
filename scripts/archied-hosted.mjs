...
export async function startHostedArchied(options = {}) {
  ...
  return Object.freeze({
    ...
    data_root: dataRoot,
    authenticateToken: security.identityForToken,
    close
  });
}
