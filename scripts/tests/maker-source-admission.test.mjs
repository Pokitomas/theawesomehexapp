...
function candidateFor(issue, overrides = {}) {
  ...
  return {
    ...
    mode: 'source_pr',
    issue,
    pull_request: Object.hasOwn(overrides, 'pull_request') ? overrides.pull_request : issue + 100,
...
function adoptionFor(issue, overrides = {}) {
  ...
  return {
    ...
    issue,
    pull_request: Object.hasOwn(overrides, 'pull_request') ? overrides.pull_request : null,
    base_sha: overrides.base_sha || BASE,
    head_sha: head,
    branch: overrides.branch || COORDINATOR,
