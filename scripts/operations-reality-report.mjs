...
export function inspectOperationsReality({ root = defaultRoot, observedAt = new Date().toISOString() } = {}) {
  ...
  const repositoryFacts = [
    ...
    inspectFile(root, 'deployment_sentinel_contract', 'scripts/deployment-receipt.cjs', ['write-sentinel', 'verify-live', 'archie-deployment.json', "product_root: 'one-request-router'", "product_model: 'one-task-progressive-views'"]),
