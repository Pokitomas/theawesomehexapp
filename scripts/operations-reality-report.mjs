...
export function inspectOperationsReality({ root = defaultRoot, observedAt = new Date().toISOString() } = {}) {
  ...
  const repositoryFacts = [
    ...
    inspectFile(root, 'deployment_sentinel_contract', 'scripts/deployment-receipt.cjs', ['write-sentinel', 'verify-live', 'archie-deployment.json', "product_root: 'desktop-program-manager'", "product_model: 'independent-programs'"]),
