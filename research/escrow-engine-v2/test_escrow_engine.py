...
from escrow_engine import (
    Artifact, Engine, OracleLedger, Reference, apply_kernel, certify, grades,
    horizon, synthesize_periodic,
)
...
def fixture():
    ...
    art = Artifact("cheap", {"tick": ka}, 2, execution_cost=0.05,
                   discovery_cost=2, verification_cost=4)
