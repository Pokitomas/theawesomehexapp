...
def main() -> None:
    ...
    for marker in (
        ...
        FUTURE_MEDIA_FINAL_STYLE_MARKER, FUTURE_MEDIA_MOBILE_STYLE_MARKER, EXPERIENCE_STYLE_MARKER, FRONTIER_STYLE_MARKER,
        SOCIAL_STYLE_MARKER, REMOTE_STYLE_MARKER, SURVIVAL_STYLE_MARKER, REMOTE_SERVICE_MARKER,
    ):
