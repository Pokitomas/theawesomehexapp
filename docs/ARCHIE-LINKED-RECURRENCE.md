...
- strict loader bound to the recorded 114M export SHA, source head and source-core blob;
- compatibility normalization for the source-only `ssm_chunk_size`, mixer and disabled-plasticity config fields;
...
- linked-segment cross-entropy for truncated backpropagation that carries the final byte of every segment.
