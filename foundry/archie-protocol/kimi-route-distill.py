...
def main():
    ...
    for start in range(0,len(rows),args.batch_size):
        ...
        for candidate in pending:
            ...
            if normalized in seen or per_route[candidate['route']]>=args.max_additions_per_route: rejected.append({'source':source_index,'reason':'post-verifier-duplicate-or-cap'}); continue
